...
Route::get('admin/reportes/reporte_formularios', ['as' => 'admin.reportes.reporte_formularios', 'uses' => 'Admin\ReporteController@reporteFormularios', 'middleware' => ['auth']]);
Route::get('admin/reportes/excelReporteFormularios', ['as' => 'admin.reportes.excelReporteFormularios', 'uses' => 'Admin\ReporteController@excelReporteFormularios', 'middleware' => ['auth']]);


Route::get('admin/reportes/reporte_landings', ['as' => 'admin.reportes.reporte_landings', 'uses' => 'Admin\ReporteController@reporteLandings', 'middleware' => ['auth']]);
Route::get('admin/reportes/excelReporteLandings', ['as' => 'admin.reportes.excelReporteLandings', 'uses' => 'Admin\ReporteController@excelReporteLandings', 'middleware' => ['auth']]);
