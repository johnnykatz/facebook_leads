<table class="table table-responsive" id="campoServicioCrms-table">
    ...
    @foreach($campoServicioCrms as $campoServicioCrm)
        <tr>
            ...
            <td>{!! $campoServicioCrm->tipo !!}</td>
            <td>{!! $campoServicioCrm->requerido !!}</td>
            <td>{!! $campoServicioCrm->codifica !!}</td>
            ...
            <td>
                ...
                <div class='btn-group'>
                    <a href="{!! route('admin.campoServicioCrms.show', [$campoServicioCrm->id]) !!}"
                       class='btn btn-default btn-xs'><i class="glyphicon glyphicon-eye-open"></i></a>
                    <a href="{!! route('admin.campoServicioCrms.edit', [$campoServicioCrm->id]) !!}"
