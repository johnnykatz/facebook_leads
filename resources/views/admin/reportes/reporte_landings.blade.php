    ...
    <script>
        $(document).ready(function () {
            ...
            $('#btn-exportar-excel').click(function () {
                ...
                $('#form_listado').attr('action', '{!! route('admin.reportes.excelReporteLandings') !!}');
                $('#form_listado').submit();
...
@section('content')
    <section class="content-header">
        <h1 class="pull-left">Reporte de landings</h1>
        <h1 class="pull-right">
        </h1>
    </section>
    <div class="content">
        ...
        <div class="box box-primary">
            <div class="box-body">
                {!! Form::model(Request::all(),['route'=>'admin.reportes.excelReporteLandings','method'=>'GET','class'=>'form-horizontal','id'=>'form_listado']) !!}
        ...
        <div class="box box-primary">
                ...
                <div class="table-responsive">
                    <table class="table table-responsive" id="landings-table">
                        ...
                        @foreach($landings as $landing)
                            <tr>
                                <td>
                                    {!!Form::checkbox('landing[]', $landing->id,null,['id'=>$landing->id]) !!}
                                </td>
            ...
            <div class="box-footer">
                <div class="form-group col-sm-12">
                    <a href="{!! route('admin.landings.index') !!}" class="btn btn-default">Volver</a>
                </div>
            </div>
        </div>
